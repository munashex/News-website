...
function Science() {
  ...
  const getHeadlines = async () => {
    let headlinesUrl =
      'https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=b254967dd62e4b51b3d79d2c8f245083';
    try {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-semibold mb-4">Science News</h1>
